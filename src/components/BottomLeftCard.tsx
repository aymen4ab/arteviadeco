  ...
  return (
    ...
    >
      <div className="flex flex-col">
        ...
        <span className="text-[10px] md:text-[12px] font-normal text-[rgba(30,50,90,0.6)] uppercase tracking-wider rtl:tracking-normal">
          {t.statLabel}
        </span>
      </div>
      ...
      >
        <div className="bg-[rgba(30,50,90,0.1)] p-1 rounded-full flex items-center justify-center">
          <ArrowUpRight className="w-4 h-4 text-[rgba(30,50,90,0.9)] rtl:-scale-x-100" />
        </div>
